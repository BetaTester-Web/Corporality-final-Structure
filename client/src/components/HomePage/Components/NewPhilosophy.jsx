        ...
        <div data-aos="fade-left" className="philosophyFormWrapper">
          <div className="philosophyForm">
            ...
            <div className="customInput">
              <label
                htmlFor="philosophyFirstName"
                className={firstName && "labelToTop"}
              >
                First Name
              </label>
              <input
                id="philosophyFirstName"
                className={firstName && "activeInput"}
                value={firstName}
            ...
            <div className="customInput">
              <label
                htmlFor="philosophyLastName"
                className={lastName && "labelToTop"}
              >
                Last Name
              </label>
              <input
                id="philosophyLastName"
                className={lastName && "activeInput"}
                value={lastName}
            ...
            <div className="customInput">
              <label
                htmlFor="philosophyEmail"
                className={email && "labelToTop"}
              >
                Email Id
              </label>
              <input
            ...
            <div className="customInput">
              <label
                htmlFor="philosophyMobile"
                className={mobile && "labelToTop"}
              >
                Mobile
              </label>
              <input
                id="philosophyMobile"
                className={mobile && "activeInput"}
                value={mobile}
