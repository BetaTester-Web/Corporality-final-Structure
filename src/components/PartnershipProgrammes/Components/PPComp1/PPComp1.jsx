            ...
            <div className="container-fluid ">
                <div className="row d-flex flex-row ppc1RowContainer">
                    <div className="col d-flex flex-column justify-content-center ppc1ColWrapper">
                        ...
                        <p data-aos="fade-right" data-aos-delay="300" data-aos-duration="500">Corporality Global holds extensive strategic strength partnership programmes that extend entrepreneurial reach beyond the ordinary</p><br />
