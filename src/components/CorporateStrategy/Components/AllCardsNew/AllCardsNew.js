    ...
    <>
      <div className="cards_top_text_container">
        ...
        <div className="cards_top_description">
          ...
          of overall company growth, businesses focused on Human to Human growth
          (not just B2B or B2C) get the option to achieve their goals faster
          than their competitors. It expedites revenue growth by getting the
          functional marketing strategies of corporate culture, sales & lead
          generation, marketing, and solutions fully aligned to the management
          team’s visionary growth strategy for the company.
        </div>
      </div>
      ...
      <div class="all_cards_parent">
        ...
        >
          ...
          <div className="cards_top_heading_text">Task Force and Execution</div>
          <div className="cards_top_heading_joiner">
            <img src={joiner} alt="" />
          </div>
        </div>
