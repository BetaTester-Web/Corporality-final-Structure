    ...
    <div className="understanding_difficulty_main_container">
      <div className="understanding_difficulty_first_text">
        ...
        <div className="understanding_difficulty_first_text_description">
          ...
          been able to really identify? If your company is showing any one of
      ...
      <div className="understanding_difficulty_last_text">
        ...
        <div className="understanding_difficulty_last_text_description">
          What exactly is the solution? Challenge your current perceptions, and
          break out of your frame of reference. As a market leader, compare
          yourself to other players to stay enlightened about their marketing
          strategies. Thereafter break it down to smaller versions and get an
          objective of your new perspective, which is closest to your vision of
          the corporate level strategy. Define the descriptors and precisely
          identify your business goals based on your new approach.
        </div>
      </div>
    </div>
  );
