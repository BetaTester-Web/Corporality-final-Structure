  ...
  return (
    <>
        ...
        <div className="row footerRow">
            ...
            <div className="foot-c">
              <nav className="menu">
                ...
                <label
                  ...
                  style={{ backgroundColor: "#f2f2f2", color: "#31647c" }}
                  htmlFor="menu-open"
                >
                  <i
                ...
                >
                  ...
                  <i
                    ...
                    style={{ marginTop: "-12px", marginLeft: "-12.5px" }}
                  />
                </a>
                <a
                ...
                >
                  ...
                  <i
                    ...
                    style={{ marginTop: "-12px", marginLeft: "-13px" }}
                  />
                </a>
                <a
                ...
                <a
                  ...
                  className="menu-item youtube"
                >
                  {" "}
                  <i
                    className="fa fa-youtube-play"
                    style={{ marginTop: "-12px", marginLeft: "-14.5px" }}
                  />{" "}
                </a>
              </nav>
            </div>
          ...
          <div className="column3">
            ...
            <p
              className="text-links"
              onClick={() => {
                navigate("/digital-media-marketing");
                topHandle();
              }}
            >
              <img className="poligon-image" src={polygon} />
            ...
            <p
              className="text-links"
              onClick={() => {
                navigate("/strategic-consultancy");
                topHandle();
              }}
            >
              <img className="poligon-image" src={polygon} />
          ...
          <div className="column4">
            ...
            <p
              className="text-links"
              onClick={() => {
                navigate("/interactive-blueprint");
                topHandle();
              }}
            >
              <img className="poligon-image" src={polygon} />
          ...
          <div className="arrow-icon-container">
            <div
              onClick={topHandle}
              className="arrow-icon-wrapper d-flex justify-content-center align-items-center"
            >
              <img src={upArrow} />
            </div>
          </div>
      ...
      <div class="footerContainer">
        ...
        <div className="row2">Copyright © 2021 Corporality</div>
      </div>
    </>
  );
}
