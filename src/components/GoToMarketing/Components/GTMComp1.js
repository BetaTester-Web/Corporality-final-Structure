            ...
            <div className="container mx-auto">
                ...
                <div className="row">
                    <div className="col-lg-5 col-8 ms-lg-0 ms-auto me-auto d-flex flex-column justify-content-center">
                        ...
                        <p class="desc mt-2 mb-2 text aos-init aos-animate"  data-aos="fade-right" data-aos-duration="2000">
                        ...
                        <div class="aos-init aos-animate" data-aos="fade-right" data-aos-duration="2000" data-aos-delay="3000">
                    ...
                    <div className="sideSocials d-flex flex-lg-column flex-row align-items-center justify-content-center">
                        <a href="/" className="socialIcon d-flex align-items-center justify-content-center ms-0 me-1">
                            <img src={fb} alt="" width="40%" />
                        </a>
                        <a href="/" className="socialIcon d-flex align-items-center justify-content-center mx-lg-0 mx-2">
