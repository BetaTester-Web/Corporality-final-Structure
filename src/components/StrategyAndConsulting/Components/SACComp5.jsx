      ...
      <div className="container SACC5_contoiner-3">
        <div className="row">
          ...
          <div className="col-lg-6 SACC5_texting-third">
            <p className="sacc4Heading1 w-100 SACC5_text-start">
              Internal Implementation for External sustenance
            </p>
            <div
              data-aos="fade-up"
              data-aos-delay="500"
              className="SACC5_textndicon"
            >
              <div className="SACC5_icon">
                <img alt="" className="SACC5_icon1" src={favicon0} />
              </div>
              <div className="SACC5_text-box-3">
                <p className="SACC5_container-3_text-1_heading">
                  Innovative and Inclusive Cultures
                </p>
                <p className="SACC5_container-3_text-1">
                  We adopt an innovative and inclusive mindset to achieve
                  organisational success and market leadership. Corporality
                  believes that internal values are always instrumental in
                  fostering external client sustenance.
                </p>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div className="SACC5_text-box-3">
                <p className="SACC5_container-3_text-2_heading">
                  Picking up the pace with Preparation
                </p>
                <p className="SACC5_container-3_text-2">
                  Corporality and its partners believe in the power of
                  preparation. We leverage the power of information and data
                  gathering to enable constructive conversations with our
                  customers to deliver actual business value.
                </p>
              </div>
            </div>
            <div
              data-aos-delay="500"
              data-aos="fade-right"
              className="SACC5_button-4"
            >
              <a className="SACC5_button-link" href="/#">
                Learn More
              </a>
            </div>
          </div>
