                ...
                <div className="row SACC1_first-image">
                    <div className="col-lg-6">
                        <div data-aos="fade-right" className="SACC1_text-box-1">
                            <p className='SACC1_container-2_text'>STRATEGY AND CONSULTING</p>
                            <p className='SACC1_container-1_text'>We truly believe in putting customers first.</p>
                            <div className="SACC1_small-rect-prev-1"><img src={smallerrect} alt='' className='SACC1_smaller-rect-prev-1' /></div>
                        </div>
                    </div>
