                ...
                <div className="row">
                    <div className="col-lg-6 d-flex third-image justify-content-center flex-column  align-items-center">
                        <div data-aos="fade-right" className='images-prev-3'>
                            ...
                            <img alt='' className='main3' src={main3} />
                            <img alt='' className='back3' src={back3} />
                        </div>
                    </div>
                    <div data-aos="fade-left" className="col-lg-6 texting-third">
                        
                        <div className="textndicon">
                            <div className="icon">
                        ...
                        <div >
                                <div data-aos="fade-right" data-aos-easing="ease-out-cubic" data-aos-duration="2000" data-aos-delay="1000" className="button-4">
