          ...
          <div className="all_contents">
            ...
            >
              <div className="main_upper_text">
                Corporality Global practices true agility the way it is supposed
                to work. All of us across the organisation work towards a common
                goal and identify with the brand as if it were our very own.
              </div>
