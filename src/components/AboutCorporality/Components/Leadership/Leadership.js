  ...
  return (
    <div className="leadership_main">
      ...
      >
        ...
        directors have been in the industry for more than 17 years, and head the
        team in being passionate for the success of our clients. We value
        relationships, collaboration, intelligent work, and community.
      </div>
      ...
      <div className="leadership_cards">
        ...
        >
          ...
          <div className="leader_card_content_box">
            ...
            <div className="card_content_description">
              “Corporality is a reflection of the core beliefs of its leaders,
              and the embodiment of the excellence of its teams. We at
              Corporality take pride in doing good work for our customers and
              honoured to play an es
            </div>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="leader_card_content_box">
            ...
            <div className="card_content_description">
              “The age of digital and booming progress of new intelligences in
              marketing is the fuel to our fire at Exante. We take every
              opportunity to learn and in turn educate and inspire others with
              practical
            </div>
          </div>
        </div>
